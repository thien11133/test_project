                ...
                <div className="row flex">
                  ...
                  <div className="col__2">
                    <div className="meta">
                      ...
                      >
                        Xin chào đến với MeoUS Shop!!!
                      </span>
                      <p>
                        MeoUs shop là một thương hiệu thời trang Việt Nam dành
                        cho giới trẻ.
                        <br />
                      ...
                      <p>
                        <h1>1"</h1> <h2>MeoUs shop </h2>mang đến cho khách hàng
                      ...
                      <p>
                        <h1>3"</h1> <h2>MeoUs shop </h2>Luôn duy trì chế độ bảo hành 365 ngày đối với mọi sản phẩm
                      </p>
